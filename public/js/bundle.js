...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibW9zdGFmYW1vaGFtZWR4eCIsImEiOiJja3NxZzU2dzYwY245MnF0Zjk3dGk0eHE5In0.w0TgjkKoW-rGGMny8TFL0A';
...
var stripe = Stripe('pk_test_51JVjO2DItxu7UQiN1QQ96IB4rOQ5gxqPXXKFQ8DZp3rsKehLkeOiKfb96mQHmiMwSvDU99jgpPRelDN5DgX3j34D00plsX5TFH');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // 2) Create checkout from + chanre credit card
...
var loginForm = document.querySelector('.form--loggin');
var updateDataBtn = document.querySelector('#update');
var updatePassword = document.querySelector('#updatePassword');
var bookTourBtn = document.getElementById('book-tour'); // MAPBOX HANDLER
...
if (updateDataBtn) updateDataBtn.addEventListener('click', function (e) {
  e.preventDefault();
  ...
  (0, _updateSettings.updateSettings)(form, 'settings');
}); // UPDATE PASSWORD HANDLER

if (updatePassword) updatePassword.addEventListener('click', function (e) {
  e.preventDefault();
  var passwordCurrent = document.querySelector('input[name="passwordCurrent"]').value;
